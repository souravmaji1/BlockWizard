...
const providerTestnet = new ethers.providers.JsonRpcProvider('https://polygon-mumbai.g.alchemy.com/v2/f6H_J2I8SuliNC0knKcMNkvyUglLyzPV');
  ...
  try {
    ...
    if (abiResponse.data.status === '1') {
      ...
      const provider = new ethers.providers.JsonRpcProvider(
        'https://polygon-mumbai.g.alchemy.com/v2/f6H_J2I8SuliNC0knKcMNkvyUglLyzPV'
      ...
      const wallet = new ethers.Wallet('90af17c6f791c03cb315a944df52ad6d0b06d9352d76ce7d7a3affca5d568bc4', provider); // Replace with your private key
